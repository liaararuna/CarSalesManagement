...
public class CarRestController {
    ...
    public CollectionModel<CarDTO> getAllCars() {
        ...
        for(Car car : carList) {
            CarDTO carDTO = new CarDTO(car.getVin(), car.getLicensePlate(), car.getNumberOfDoors(), car.getColor(), car.getReleaseYear(), car.getModelId(), car.getFuelType(), car.getCarStatus());
    ...
    public ResponseEntity<CarDTO> addCar(@RequestBody CarDTO carDTO) {
        ...
        Car newCar =  carService.addCar(new Car(carDTO.getVin(), carDTO.getLicensePlate(), carDTO.getNumberOfDoors(), carDTO.getColor(), carDTO.getReleaseYear(), carDTO.getModelId(), carDTO.getFuelType(), carDTO.getCarStatus()));
        CarDTO resp = new CarDTO(newCar.getVin(), newCar.getLicensePlate(), newCar.getNumberOfDoors(), newCar.getColor(), newCar.getReleaseYear(), newCar.getModelId(), newCar.getFuelType(), newCar.getCarStatus());
    ...
    public ResponseEntity<CarDTO> updateCar(@PathVariable("vin") int vin,
        ...
        carDTO.setVin(vin);
        Car updatedCar = carService.update(new Car(carDTO.getVin(), carDTO.getLicensePlate(), carDTO.getNumberOfDoors(), carDTO.getColor(), carDTO.getReleaseYear(), carDTO.getModelId(), carDTO.getFuelType(), carDTO.getCarStatus()));
        CarDTO carDTO2 = new CarDTO(updatedCar.getVin(), updatedCar.getLicensePlate(), updatedCar.getNumberOfDoors(), updatedCar.getColor(), updatedCar.getReleaseYear(), updatedCar.getModelId(), updatedCar.getFuelType(), updatedCar.getCarStatus());
